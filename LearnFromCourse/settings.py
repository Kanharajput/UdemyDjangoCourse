"""
Django settings for LearnFromCourse project.
...
SECRET_KEY = 'django-insecure-44i@8oxi@l#re6%aagn_wvwhh!u!*)31#pt6vr=uijej40$g@%'
...
INSTALLED_APPS = [
    ...
    'django.contrib.staticfiles',         # check this, it is used to manage static files
]
...
ROOT_URLCONF = 'LearnFromCourse.urls'
...
WSGI_APPLICATION = 'LearnFromCourse.wsgi.application'
